...
sf::FloatRect Bow::getHitbox(sf::Vector2f entityCenter, sf::Vector2f attackDir) {
    // Tạm thời: hitbox nhỏ xung quanh entity
    return sf::FloatRect(entityCenter - sf::Vector2f(15.f, 15.f), sf::Vector2f(30.f, 30.f));
}

bool Bow::isHitting(sf::Vector2f attackerPos, sf::Vector2f attackDir, sf::Vector2f targetPos) {
